defmodule OrbShowcase.Widgets.Combobox do
  ...
  defmodule DataSource do
    ...
    defp do_states_data() do
      ...
      stride = for [state, _abbreviation] <- rows, reduce: 0 do
  ...
  defwp trim_nul_bytes(start: I32, max_length: I32), I32, i: I32 do
    loop EachChar do
  ...
  defwp state_at_index(index: I32), Str, start: I32 do
    start = States.Values.start_byte_offset() + (index - 1) * DataSource.states_data().stride
    {start, trim_nul_bytes(start, DataSource.states_data().stride)}
  end
  ...
  defwp input(), StringBuilder do
    build! do
      ...
      ~S|"  data-keydown-arrow-down="focus_next_item">|
    end
  end
